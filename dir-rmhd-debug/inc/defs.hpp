...
// problem generator
#define PROBLEM_GENERATOR "tdesph"
...
#define COMPILED_WITH_OPTIONS " -I/usr/local/spack/opt/spack/linux-debian12-x86_64/gcc-12.2.0/hdf5-1.14.3-axfckcsvg3pbga7p6kjjl3zikilheyhk/include -O0 --std=c++11 -g  -Idir-rmhd-debug/inc -Idir-rmhd-debug/inc/a -Idir-rmhd-debug/inc/a/b -Idir-rmhd-debug/inc/a/b/c -Idir-rmhd-debug/inc/a/b/c/d -Idir-rmhd-debug/inc/a/b/c/d/e  -L/usr/local/spack/opt/spack/linux-debian12-x86_64/gcc-12.2.0/hdf5-1.14.3-axfckcsvg3pbga7p6kjjl3zikilheyhk/lib  -lhdf5" // NOLINT
